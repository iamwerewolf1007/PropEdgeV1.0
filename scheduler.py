...
# ─────────────────────────────────────────────────────────────────────────────
AGENTS = {
    "b0": "com.propedge.v1.batch0",
    "b1": "com.propedge.v1.batch1",
    "b2": "com.propedge.v1.batch2",
    "b3": "com.propedge.v1.batch3",
    "b4": "com.propedge.v1.batch4",
    "b5": "com.propedge.v1.batch5",
    "db": "com.propedge.v1.daily",
}
...
def main() -> None:
    ...
    if cmd == "install":
        print("\n  Installing PropEdge V1.0 launchd agents (weekday schedule)...")
        install()
    elif cmd == "uninstall":
        print("\n  Uninstalling PropEdge V1.0 agents...")
        uninstall()
    elif cmd == "reinstall":
        uninstall()
        install()
