"""
PropEdge V1.0 — generate_season_json.py
...
def score_and_grade(
    ...
    for pi, prop in enumerate(props):
        ...
        # IMPORTANT: grading direction is ALWAYS OVER for generate.
        # The Props Excel contains OVER bets only (player scores OVER their line).
        # The model direction (dl) is stored on the play for prediction use but
        # must NOT be used for grading — that would cause results to change every
        # time the game log updates and prb12 crosses the 0.5 threshold.
        ...
        if not actual_row.empty:
            ...
            if abs(actual_pts - line) < 0.05:
                ...
                # Always grade as OVER — the Props Excel is an OVER bet database
...
def _run_generate_locked() -> None:
    ...
    if not props_2425:
        ...
        plays_2425 = score_and_grade(props_2425, season="2024-25", **kwargs)
    ...
    if not props_2526:
        ...
        plays_2526 = score_and_grade(props_2526, season="2025-26", **kwargs)
